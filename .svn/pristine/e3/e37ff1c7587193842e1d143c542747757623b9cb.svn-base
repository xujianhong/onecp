...
import com.daomingedu.onecp.di.component.DaggerSelectImageVideoComponent
 ...
 * }
 */
class SelectImageVideoAct : BaseActivity<SelectImageVideoPresenter>(), SelectImageVideoContract.View{
    companion object {
