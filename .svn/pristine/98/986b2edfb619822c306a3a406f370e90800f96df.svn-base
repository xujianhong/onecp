 ...
 * Description :
 */
class JHCGlideImageLoaderStrategy : BaseImageLoaderStrategy<JHCImageConfig>, GlideAppliesOptions {

	override fun loadImage(ctx: Context?, config: JHCImageConfig?) {
	...
	override fun clear(ctx: Context?, config: JHCImageConfig?) {
		if (ctx == null) throw NullPointerException("Context is required")
		if (config == null) throw NullPointerException("ImageConfigImpl is required")
