...
import com.daomingedu.onecp.app.UploadFileRequestBody
...
interface CommonService {
     ...
     */
    @FormUrlEncoded
    @POST("api/common/getSchool")
    fun getSchool(
        @Field("county") county: String, @Field("keyWords") keyWords: String,
     ...
     */
    @FormUrlEncoded
    @POST("api/common/getPlace")
    fun getProvince(
        @Field("pid") pid: String, @Field("key") key: String
