package com.daomingedu.onecp.mvp.ui.widget.selectimagevideo.itemdecoration;
...
public class DividerGridItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if(isLastRow(parent,parent.getChildLayoutPosition(view),spanCount,childCount)){// 如果是最后一行，则不需要绘制底部
            outRect.set(0,0,mDivider.getIntrinsicWidth(),0);
        }else if(isLastColum(parent,parent.getChildLayoutPosition(view),spanCount,childCount)){// 如果是最后一列，则不需要绘制右边
